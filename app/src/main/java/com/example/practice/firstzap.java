...
public class firstzap extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firstzap);
    ...
    class MyTask extends AsyncTask<String,Void, ArrayList<String[]>>{
        ...
        protected void onPostExecute(ArrayList<String[]> result){
            ...
            firstzap.ClAdapter clAdapter = new firstzap.ClAdapter(tvInfo.getContext(),result);
            ListView lvMain = (ListView) findViewById(R.id.lvMain);
            lvMain.setAdapter(clAdapter);
            tvInfo.setText("Результаты поиска");
